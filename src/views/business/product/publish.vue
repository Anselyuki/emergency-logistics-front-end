<template>
  <div id="publishStocks">
    ...
    >
      ...
      <el-breadcrumb-item :to="{ path: '/business/product/out-stocks' }"
        >出库记录</el-breadcrumb-item
      >
  ...
  data() {
    ...
    return {
      ...
      addRules: {
        ...
        priority: [
          { required: true, message: "请选中发放类型", trigger: "blur" },
        ],
        remark: [
