...
const routes = [
...

    {
        ...
        children: [
			...
			{
			    path: '/business/product/check',
			    name: 'ProductCheck',
			    component: () => import( '../views/business/product/check'),   //物资审核
			},
			{
			    path: '/business/product/path',
			    name: 'ProductPath',
			    component: () => import( '../views/business/product/path'),   //路径生成
			},
			{
			    path: '/business/product/goto',
			    name: 'ProductGoto',
			    component: () => import( '../views/business/product/goto'),   //物资审核
			},
            /**********************************监控模块的路由******************************/
            {
                path: '/monitor/logs',
            ...
            /**********************************物流模块的路由******************************/
            {
                ...
                component: () => import( '../views/business/logistics/vehicles'), //配送车辆
            },
            {
                path: '/logistics/staff',
                name: 'LogisticseStaff',
                component: () => import( '../views/business/logistics/staff'), //配送人员
            },
            {
                path: "/error/401",
